export const TEMP_PROMPT = () => ({
  prompt: {
    ...
    '6': {
      inputs: {
        text: '(solo:1.2), a ultrarealistic photo of \bslender korean idol girl with (red short hair:1.1) (looking at viewer and looking ahead:1.4) wearing (black rococo dress:1.2), (highly detailed eyes:1.3), masterpiece, best quality, 8k,',
        clip: ['4', 1],
      },
    ...
    '10': {
      inputs: {
        seed: Math.floor(Math.random() * (100000000000 - 100000 + 1)) + 100000,
        steps: 15,
        cfg: 7,
  ...
  extra_data: {
    extra_pnginfo: {
      workflow: {
        ...
        config: {},
        extra: {
          ds: { scale: 1, offset: [-161.2287277343753, -159.59105429687474] },
        },
        version: 0.4,
      },
    },
